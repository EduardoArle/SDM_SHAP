...
pos_latAmp_15 <- sum(res_temp_large_ranges2$minTslope_RP > 0) /
  nrow(res_temp_large_ranges2) * 100
neg_latAmp_15 <- sum(res_temp_large_ranges2$minTslope_RP < 0) /
  nrow(res_temp_large_ranges2) * 100
...
pos_minLat_40 <- sum(res_temp_large_ranges2$minTslope_RP > 0) /
  nrow(res_temp_large_ranges2) * 100
neg_minLat_40 <- sum(res_temp_large_ranges2$minTslope_RP < 0) /
  nrow(res_temp_large_ranges2) * 100
...
pos_maxLat_40 <- sum(res_temp_large_ranges2$minTslope_RP > 0) /
  nrow(res_temp_large_ranges2) * 100
neg_maxLat_40 <- sum(res_temp_large_ranges2$minTslope_RP < 0) /
  nrow(res_temp_large_ranges2) * 100
...
pos_latAmp_15 <- sum(res_temp_large_ranges2$meanTslope_RP > 0) /
  nrow(res_temp_large_ranges2) * 100
neg_latAmp_15 <- sum(res_temp_large_ranges2$meanTslope_RP < 0) /
  nrow(res_temp_large_ranges2) * 100
...
pos_minLat_40 <- sum(res_temp_large_ranges2$meanTslope_RP > 0) /
  nrow(res_temp_large_ranges2) * 100
neg_minLat_40 <- sum(res_temp_large_ranges2$meanTslope_RP < 0) /
  nrow(res_temp_large_ranges2) * 100
...
pos_maxLat_40 <- sum(res_temp_large_ranges2$meanTslope_RP > 0) /
  nrow(res_temp_large_ranges2) * 100
neg_maxLat_40 <- sum(res_temp_large_ranges2$meanTslope_RP < 0) /
  nrow(res_temp_large_ranges2) * 100
